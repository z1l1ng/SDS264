...
vaccine_data |>
  ...
  labs(x = "Percent of Votes for Biden in County", 
       y = "Percent of Country Fully Vaccinated From Covid", 
       color = "State")
```
...
```
FINISH LATER
I prefer the second graph because I can see the data better after using facet wrap. From my preferred plot we can see that all states see a postive trend line with the higher percentage of votes for Biden the higher percentage that the county is fully vaccinated from Covid. Iowa, Minnesota, and Wisconsin have super similar trends as in the minimum of....
